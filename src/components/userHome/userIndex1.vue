    ...
    <div class="userIndex-header">
      ...
      <div class="money-tabs-box">
        <div class="money-tabs-left">
          ...
          <select class="coinStyle" @click="coinStyle11($event)">
      ...
      <div class="total-assets">
        <div class="assets-box">
          <div class="assets-content">
            ...
            <span class="assets-money">{{this.compulationMoneyT1('.balance1')}}{{zongjia}} {{money_style}}</span>
            <div v-show="money_hide1">
              <div v-for="(item,index) in AccountCNY" :class="'assets_'+item">
                <span></span><span><em>{{item}}</em> {{(CNYMoneny[item] ? CNYMoneny[item].balance : 0)|float8}}
      ...
      <div class="net-assets">
        <div class="assets-box">
          <div class="assets-content">
            ...
            <span
              class="assets-money">{{this.compulationMoneyT1('.balance2')}}{{jingjia}} {{money_style}}</span>
            <div v-show="money_hide1">
      ...
      <div class="available-assets" v-show="!more_style">
        <div class="assets-box">
          <div class="assets-content">
            ...
            <span
              class="assets-money">{{this.compulationMoneyT1('.amount')}}{{keyong}} {{money_style}}</span>
            <div v-show="money_hide1">
              <div v-for="item in AccountCNY" :class="'assets_'+item">
                <span></span><span><em>{{item}}</em> {{(CNYMoneny[item] ? CNYMoneny[item].amount : 0)|float8}}
                 <transition enterActiveClass="animated fadeIn" leaveActiveClass="animated fadeOut">
                <aside style="display: inline-block"
                       v-show="money_style!==item"
      ...
      <div class="blocked-assets" v-show="!more_style">
        <div class="assets-box">
          <div class="assets-content">
            ...
            <span
              class="assets-money">{{this.compulationMoneyT1('.locked')}}{{dongjie}} {{money_style}}</span>
            <div v-show="money_hide1">
              <div v-for="item in AccountCNY" :class="'assets_'+item">
  ...
  export default {
    data() {
      return {
        ...
        keyong: '',
        dongjie: '',
        colorM: ['#fead22', '#ff0', '#0f0', '#38c1e8', '#2dd1a5', '#9c5ff9'],
        dataMZ: [],
        dataMJ: [],
        dataMK: [],
        dataMD: [],
    ...
    methods: {
      ...
      drawing1() {
        let ZEcharts = this.$echarts.init(document.getElementById('ZEcharts1'));
        let JEcharts = this.$echarts.init(document.getElementById('JEcharts1'));
        let KEcharts = this.$echarts.init(document.getElementById('KEcharts1'));
        let DEcharts = this.$echarts.init(document.getElementById('DEcharts1'));
        ZEcharts.clear();
        JEcharts.clear();
        KEcharts.clear();
        DEcharts.clear();
        ...
        this.$http({
          ...
          if (res.data.code === 200) {
            ...
            for (let i = 0; i < dd.length; i++) {
              if (dd[i].commodity.substr(-3) === 'BTC') {
...
//          console.log(res)
          this.AccountCNY = res.data.data.BTC;
        })
      },
//      获取用户资金信息
      getCapitalInfo1(){
